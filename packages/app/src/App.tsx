...
function Home() {
    ...
    return <Tabs.Navigator screenOptions={{ headerStyle: { backgroundColor: '#526b98' }, headerTintColor: 'white', tabBarActiveTintColor: '#526b98' }}>
        <Tabs.Screen name="chatlist" component={ChatList} options={{ title: '聊天', headerLeft: () => <SelfInfo />, headerRight: () => loggedIn ? <ChatListRightButton /> : <Button title="登录" color="white" onPress={() => Actions.login()} />, tabBarIcon: ({ color, size }) => <Ionicons name="chatbubbles-outline" color={color} size={size} /> }} />
...
export default function App() {
    return <SafeAreaProvider><View style={{ flex: 1 }}>
        <NavigationContainer ref={navigation}>
            <Stack.Navigator screenOptions={{ headerStyle: { backgroundColor: '#526b98' }, headerTintColor: 'white' }}>

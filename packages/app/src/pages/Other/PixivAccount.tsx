...
export default function PixivAccount({ close }: { close: () => void }) {
    ...
    return <Modal visible animationType="slide" onRequestClose={close}><SafeAreaView style={{ flex: 1, padding: 20, backgroundColor: theme.color('#eaf0f6', 'backgroundColor') }}>
        ...
        <TextInput value={session} onChangeText={setSession} placeholder="PHPSESSID" secureTextEntry autoCapitalize="none" autoCorrect={false} maxLength={4096} style={{ backgroundColor: theme.input, borderRadius: 8, padding: 12, marginVertical: 12 }} />
